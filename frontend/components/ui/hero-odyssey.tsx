    ...
    <div className="relative w-full bg-black text-white overflow-hidden">
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 h-screen">
        ...
        >
          <div className="flex items-center">
            ...
            <div className="hidden md:flex items-center space-x-6 ml-8">
              ...
              <Link href="/about" className="px-4 py-2 text-white hover:text-gray-300 transition-colors">About</Link>
            </div>
          </div>
          <div className="flex items-center space-x-4">
            <Link href="/about" className="hidden md:block px-4 py-2 text-sm hover:text-gray-300 transition-colors">About</Link>
            <Link href="/chat" className="px-4 py-2 bg-white text-black backdrop-blur-sm rounded-full text-sm hover:bg-gray-100 transition-colors font-medium">Try AI Chat</Link>
            {/* Mobile menu button */}
            <button
        ...
        {mobileMenuOpen && (
          <motion.div
            ...
            <div className="flex flex-col items-center justify-center h-full space-y-6 text-lg">
              ...
              <Link href="/" className="px-6 py-3 bg-white text-black rounded-full font-medium" onClick={() => setMobileMenuOpen(false)}>Home</Link>
              <Link href="/chat" className="px-6 py-3 text-white hover:text-gray-300" onClick={() => setMobileMenuOpen(false)}>AI Chat</Link>
              <Link href="/about" className="px-6 py-3 text-white hover:text-gray-300" onClick={() => setMobileMenuOpen(false)}>About</Link>
            </div>
          </motion.div>
        )}
        ...
        >            <ElasticHueSlider
          ...
          >
            Meet Trishul: Your Intelligent Web3 Assistant for Smart Contracts, Payments, and Beyond
          </motion.p>
